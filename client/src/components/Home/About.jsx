...
const About = () => {
  ...
  return (
    <>
      <section id='about' className="banner relative overflow-hidden bg-cover bg-center flex justify-center items-center mx-2  h-[205vh] md:h-[130vh] " style={{ backgroundImage: `url(${backgroundImage})` }}>

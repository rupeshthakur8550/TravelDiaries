...
const Commitments = () => {
    ...
    useEffect(() => {
        const commitmentSection = document.querySelector('#commitments');
        ...
        return () => {
            if (commitmentSection) {
                observer.unobserve(commitmentSection);
            }
        };
    }, []);

    return (
        <div id="commitments" className="container mx-auto px-4 mt-10 mb-10">
            <div className="mb-8">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                ...
                <div className="md:w-1/2 text-center md:text-left gap-3" style={{ animation: isVisible ? 'fadeIn 1s ease-out' : 'none' }}>
                    ...
                    <div className="flex flex-wrap justify-between mr-2 ml-2">
                        <div className="w-full sm:w-[45%] h-[150px] mb-12" style={{ animation: isVisible ? 'slideIn 1s ease-out 0.2s forwards' : 'none' }}>
                        ...
                        <div className="w-full sm:w-[45%] h-[150px] mb-12" style={{ animation: isVisible ? 'slideIn 1s ease-out 0.4s forwards' : 'none' }}>
                            <h4 className="flex items-center text-blue-600 font-semibold mb-4">
                        ...
                        <div className="w-full sm:w-[45%] h-[150px] mb-12" style={{ animation: isVisible ? 'slideIn 1s ease-out 0.6s forwards' : 'none' }}>
                            <h4 className="flex items-center text-blue-600 font-semibold mb-4">
                        ...
                        <div className="w-full sm:w-[45%] h-[150px] mb-12" style={{ animation: isVisible ? 'slideIn 1s ease-out 0.8s forwards' : 'none' }}>
                            <h4 className="flex items-center text-blue-600 font-semibold mb-4">

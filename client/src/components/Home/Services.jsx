...
const Services = () => {
    return (
        <div className="relative">
            ...
            <div className="flex flex-col justify-center items-center h-full gap-8 pl-8 pr-8 pt-8 pb-8 md:flex-row md:items-center md:gap-8" style={{ backgroundImage: `url(${imagebkg})`, minHeight: '400px', backgroundSize: 'cover' }}>

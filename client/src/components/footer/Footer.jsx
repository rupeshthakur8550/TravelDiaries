                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-700 font-medium">
                                ...
                                <li>
                                    <Link to="https://www.linkedin.com/in/rupesh-thakur-010209207" className="hover:underline  hover:text-orange-700">
                                        LinkedIn
                                    </Link>
                                </li>
                            </ul>
                ...
                <div className="md:flex sm:block md:justify-between pl-4 pr-4">
                    <div className="flex mt-4 space-x-5 sm:mt-0 justify-center">
                        <span className="text-sm font-semibold text-gray-900">
                            © 2023-24
                            <a href="#" className="hover:underline hover:text-black pl-2 pr-2">
                                rupeshthakur
                            </a>
                             All Rights Reserved.
                        </span>

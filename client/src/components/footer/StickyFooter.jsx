...
function StickyFooter() {
  return (
    <div className='fixed bottom-0 left-0 right-0 h-12 bg-white z-50 flex sm:hidden flex-row justify-center items-center gap-10 pr-2 pl-2' style={{ boxShadow: '0px -5px 10px rgba(0, 0, 0, 0.15)' }}>
      <NavLink to="/allposts">
